...
Redis и PostgreSQL. Проект реализован до активного использования AI-инструментов, с самостоятельной проработкой backend-архитектуры, инфраструктуры и интеграции Kafka/Redis/PostgreSQL.
